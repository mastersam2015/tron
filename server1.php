...
<center>
<strong style="color:00ff00;">player1</strong><br>
...
if($i==0){
if ($j>48){
//echo "<td style=\"background-color:c0c0c0;\"></td>";
$z=1;
}else{
echo "<td class=\"cze\"></td>";
$z=1;
...
<table border="1" ><tr><td width="30">player1<br><?  echo $p1; ?></td><td width="30">
<?
echo "</td><td width=\"30\">player2<br>".$p2."</td></tr></table>";
//--------------------------------------------zapis do plikow
